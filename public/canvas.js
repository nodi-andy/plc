            ...
            if (node && this.allow_interaction && !skip_action && !this.read_only) {
                ...
                if (!this.connecting_node && !node.flags.collapsed && !this.live_mode) {
                    ...
                    if (!skip_action &&
                        ...
                        Math.isInsideRectangle(e.canvasX,
                            e.canvasY,
                ...
                if (!skip_action) {
                    ...
                    if (this.selected_group && !this.read_only) {
                        ...
                        var dist = Math.distance([e.canvasX, e.canvasY], [this.selected_group.pos[0] + this.selected_group.size[0], this.selected_group.pos[1] + this.selected_group.size[1]]);
    ...
    processMouseUp(e) {
        ...
        if (e.which == 1) {
            ...
            if (this.dragging_rectangle) {
                ...
                if (node &&
                    e.click_time < 300 &&
                    Math.isInsideRectangle(e.canvasX, e.canvasY, node.pos[0], node.pos[1] - LiteGraph.NODE_TITLE_HEIGHT, LiteGraph.NODE_TITLE_HEIGHT, LiteGraph.NODE_TITLE_HEIGHT)) {
                    node.collapse();
                }
    ...
    */
    ...
    computeVisibleNodes(nodes, out) {
        ...
        for (var i = 0, l = nodes.length; i < l; ++i) {
            ...
            if (!Math.overlapBounding(this.visible_area, n.getBounding(temp))) {
                continue;
            } //out of the visible area
    ...
    drawButton(x, y, w, h, text, bgcolor, hovercolor, textcolor) {
        ...
        var pos = this.mouse;
        var hover = Math.isInsideRectangle(pos[0], pos[1], x, yFix, w, h);
        pos = this.last_click_position;
        var clicked = pos && Math.isInsideRectangle(pos[0], pos[1], x, yFix, w, h);
